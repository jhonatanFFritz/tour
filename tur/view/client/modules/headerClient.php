...
<div class="searchBar">
        ...
        <div class="searchContainer">
            <input type="search" class="searchBox" name="mainSearch" id="mainSearch" placeholder="¿Que lugar quieres visitar?">
        </div>
        <div class="searchButon">
            <img src="../../../public/img/icons/seacrhicon.svg" alt="" class="iconimg">
        </div>
    
</div>

<div class="nav">
    <ul class="secondPages centro">
        <li class="pages nos"> 
                <div class="linkIcon  no">
                    <img src="../../../public/img/icons/search2.svg" alt="" class="arrow no">
                </div>
            </a>    
        </li>
        <li class="pages hidex2"> 
            <a href="#" class="pagesItem centro">
                <span class="linkText">
                    Español
                </span>
                <div class="linkIcon">
                    <img src="../../../public/img/icons/arrow.svg" alt="" class="arrow">
                </div>
            </a>    
        </li>
        <li class="pages hidex2"> 
            <a href="#" class="pagesItem centro">
                <span class="linkText" id="money">
                    Dolar(US$)
                </span>
                <div class="linkIcon">
                    <img src="../../../public/img/icons/arrow.svg" alt="" class="arrow">
        ...
        <li class="pages"> 
            <a href="#" class="pagesItem centro">
                <div class="linkIcon">
                    <img src="../../../public/img/icons/heart.svg" alt="" class="arrow">
                </div>
                <span class="linkText hide">
                    Faboritos
                </span>
            </a>    
        </li>
        <li class="pages"> 
            <a href="#" class="pagesItem centro">
                <div class="linkIcon">
                    <img src="../../../public/img/icons/cart.svg" alt="" class="arrow">
                </div>
                <span class="linkText hide">
                Carrito
                </span>
        ...
        <li class="pages"> 
            <a href="#" class="pagesItem centro">
                <div class="linkIcon">
                    <img src="../../../public/img/icons/help.svg" alt="" class="arrow">
                </div>
                <span class="linkText hide">
                    Ayuda
                </span>
        ...
        <li class="pages"> 
            <a href="#" class="pagesItem centro">
                <div class="linkIcon">
                    <img src="../../../public/img/icons/user.svg" alt="" class="arrow">
                </div>
                <span class="linkText hide">
                    Iniciar sesión  
                </span>
                <div class="linkIcon ini">
                    <img src="../../../public/img/icons/arrow.svg" alt="" class="arrow">
                </div>
            </a>    
        </li>
        <li class="pages pad hidex2"> 
            <a href="#" class="pagesItem btnSingin">
                <span class="linkText">
                    Registrarse
                </span>
            </a>    
